...
| 2 | **🤖 What is an agent (really)?** | A practical definition of an agent + building a simple agent **from scratch** using only the OpenAI Chat Completions API. | Published |   2026-04-21    |
| 3 | **🏗️ Building with frameworks — LlamaIndex basics** | Why we need an agent framework, what it abstracts, and how to get productive fast with LlamaIndex — plus how to plug in models from Hugging Face (e.g., Qwen) as an alternative to hosted APIs. | Scheduled |   2026-05-19    |
